								...
								<div class="row">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<span class="input-group-addon">开售时间</span>
											<input type="text" class="form-control" id="minStartInvestTime" name="minStartInvestTime" readonly="readonly">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<input type="text" class="form-control" id="maxStartInvestTime" name="maxStartInvestTime" readonly="readonly">
											<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
						...
						<table id="myTable"
							...
							<thead>
								<tr>
									...
									<th data-field="start_invest_time">开售时间</th>
