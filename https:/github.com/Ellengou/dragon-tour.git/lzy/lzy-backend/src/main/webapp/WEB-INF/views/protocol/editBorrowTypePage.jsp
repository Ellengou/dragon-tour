...
<body>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="myForm">
									<input type="hidden" id = "id" name="id" value="${borrowType.id }">
									<div class="row">
										<div class="col-xs-12">
											<div class="input-group">
												<span class="input-group-addon">名称</span> 
												<input type="text" class="form-control" id="name" name="name" value="${borrowType.name }">
											</div>
										</div>
									</div>
									<hr>
									<div class="row" align="center">
										<div class="col-xs-12">
										<shiro:hasPermission name="borrow:type:update">
	...
	<script>
		function submit(){
			...
			$.ajax({
			      url: '<%=request.getContextPath()%>/admin/borrowType/update',
			      dataType: 'json',
			      type: 'POST',
			      data: jsonData,
