			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3>${prodName }</h3><button type="button" class="btn btn-primary" onclick="add()">新增</button>
					</div>
	...
	<script>
		...
		function add(){
			layer.open({
	    	    ...
	    	    area: ['500px', '400px'],
	    	    title: false,
	    	    content: '<%=request.getContextPath()%>/admin/protocolType/addProdTypeProPage?prodTypeId=${prodTypeId}'
	    	});
		}
	</script>
</body>
