...
<body>
	<shiro:hasPermission name="withdraw:lcPlayStatus">
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form id="myForm" action="<%=request.getContextPath()%>/admin/withdraw/lcWithdrawPassExport" method="GET" target="_blank">
								<div class="row">
									<div class="col-xs-2">
				...
				<div class="panel-heading">
					...
					<shiro:hasPermission name="withdraw:lcPass:export">
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="myTable"
							...
							data-url="<%=request.getContextPath()%>/admin/withdraw/queryCheckLcWithdrawsPass"
	...
	function tableCallBack(data,id){
	 ...
	 function exportNow(){
		...
		function exportAll(){
			window.open("<%=request.getContextPath()%>/admin/withdraw/lcWithdrawPassExport");
		}
		...
		function playMoney(ids){
			...
			layer.confirm('是否确定此操作？', {
				...
				$.ajax({
				      url: '<%=request.getContextPath()%>/admin/withdraw/lcPlayStatus',
				      dataType: 'json',
				      type: 'POST',
				      data: {
				    	  ids: ids
