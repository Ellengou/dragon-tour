...
<body>
							...
							<div class="col-lg-12">
								...
								<%@ include file="/WEB-INF/views/loan/template/productTemplate.jsp"%>
									...
									<div id="myTabContent" class="tab-content">
									   ...
									   <div  class="tab-pane fade" id="repayPlan">
									   		<iframe id = "i_repayPlan" width="100%" style="border: 0" height="400px"></iframe>
									   </div>
									</div>
								</form>
	...
	$('#myTab a').click(function (e) {
		  ...
		  }else if($this.attr('href') == "#repayPlan"){
			  var url = "<%=request.getContextPath()%>/admin/project/loan/queryRepayInfoPage?id="+loanId;
			  if(typeof ($("#i_repayPlan").attr('src')) == 'undefined'){
				  $("#i_repayPlan").attr('src',url);
			  }
		  }
		  $this.tab('show')
		})
