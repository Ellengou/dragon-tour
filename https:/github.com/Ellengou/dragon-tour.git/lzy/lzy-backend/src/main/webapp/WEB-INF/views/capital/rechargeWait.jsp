...
<body>
	<shiro:hasPermission name="recharge:getStatus">
	    <input id="p_getStatus" style="display: none" value="1">
	</shiro:hasPermission>
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form id="myForm" action="<%=request.getContextPath()%>/admin/recharge/rechargeExportForWait" method="GET" target="_blank">
								<div class="row">
									<div class="col-xs-4">
				...
				<div class="panel-heading">
					<shiro:hasPermission name="recharge:export:wait">
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="myTable"
							...
							data-url="<%=request.getContextPath()%>/admin/recharge/queryRechargesForWait"
	...
	function tableCallBack(data,id){
    	if(id == 'status'){
    		...
    		if($('#p_getStatus').val() == 1){
    			if(data.payWay == '0'){
    				return '<button type="button" class="btn btn-primary btn-xs" onclick="getStatus(\'' + data.id + '\');">查询状态</button> ';
    			}
    		}
    		return '';
    	}else{
	...
	function exportAll(){
		window.open("<%=request.getContextPath()%>/admin/recharge/rechargeExportForWait");
	}
	
	//查询银联状态
	function getStatus(id){
		$.ajax({
		      url: '<%=request.getContextPath()%>/admin/recharge/getRechargeStatus',
		      dataType: 'json',
		      type: 'POST',
		      data: {
		    	  id: id
