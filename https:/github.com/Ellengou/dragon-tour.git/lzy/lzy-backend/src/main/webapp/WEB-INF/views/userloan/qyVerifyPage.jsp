...
<div id="page-wrapper" style="padding: 0 15px;">
	...
	$('#dataFile').fileinput({
        ...
        showClose:false,
        showUpload:false,
        uploadUrl: '<%=request.getContextPath()%>/pics/userLoanQySh?id=${id }',
        showPreview:false,
	...
	function save(){
		idx = layer.load();
		var url = '<%=request.getContextPath()%>/admin/userloan/saveQyVerify';
		$.ajax({
		      url: url,
		      dataType: 'json',
		      type: 'POST',
	...
	function redirect(target){
		...
		t.attr('class','active');
		window.parent.parent.location = t.attr('href')
	}
