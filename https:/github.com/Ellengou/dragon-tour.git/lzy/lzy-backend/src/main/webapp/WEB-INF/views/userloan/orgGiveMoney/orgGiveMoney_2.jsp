...
<body>
								...
								<form id="myForm">
									...
									<div id="myTabContent" class="tab-content">
										<div class="tab-pane fade in active" id="verifySituation">
											<%@ include file="/WEB-INF/views/userloan/template/verifyTemplate-org.jsp"%>
   										</div>
									   <div class="tab-pane fade" id="dataProve">
											  ...
											  <div class="panel-body" id = "qyverify">
											  	<input id="dataFile_qy" type="file" disabled="disabled" class="file" multiple>
											  </div>
											</div>
											<div class="panel panel-default">
											  <div class="panel-heading">
											    <h3 class="panel-title">第三方机构上传资料</h3>
											  </div>
											  <div class="panel-body" id = "orgverify">
											  	<input id="dataFile_org" type="file" disabled="disabled" class="file" multiple>
											  </div>
											</div>
									   </div>
	...
	function GiveMoney(){
		layer.open({
    	    ...
    	    title: '放款',
    	    content: '<%=request.getContextPath()%>/admin/userloan/orgGiveMoneyPage?id=' + '${loan.id}'
    	});
    }
	</script>
</body>
