...
<body>
	...
	//设置借款人对象
	$("#jkrdx").showList('radio',{infoList:'${scf_loan_jkrdx}',name:'businessType',column_name:'dicDataName',column_value:'dicDataValue',selectValue:'${scfLoan.businessType}',lableClass:'checkbox-inline'});
	//核心公司列表
