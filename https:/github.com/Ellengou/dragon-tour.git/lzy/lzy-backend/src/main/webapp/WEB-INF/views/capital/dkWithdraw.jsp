...
<body>
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form id="myForm" action="<%=request.getContextPath()%>/admin/withdraw/dkWithdrawAllExport" method="GET" target="_blank">
								<div class="row">
									<div class="col-xs-2">
				...
				<div class="panel-heading">
					<shiro:hasPermission name="withdraw:dkAll:export">
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="myTable"
							...
							data-url="<%=request.getContextPath()%>/admin/withdraw/queryDkWithdraws"
	...
	function exportAll(){
		window.open("<%=request.getContextPath()%>/admin/withdraw/dkWithdrawAllExport");
	}
	</script>
</body>
</html>