	...
	<script>
		...
		function submit() {
			...
			if($('#file_name').val() != null && $('#file_name').val() != ''){
				$.ajaxFileUpload({
					url : '<%=request.getContextPath()%>/admin/protocolContent/uploadPic',
					secureuri:false,
			        method : 'POST',  
					...
					success: function (data, status) {
						if(data.status == 'ok'){
							...
							$.ajax({
							      url: '<%=request.getContextPath()%>/admin/protocolContent/editContent',
							      dataType: 'json',
							      type: 'POST',
							      data: jsonData,
		...
		function checkSerialNum(){
			...
			$.ajax({
			      url: '<%=request.getContextPath()%>/admin/protocolContent/getContentBySerialNum',
			      dataType: 'json',
			      type: 'POST',
			      data: {
