...
<body>
<shiro:hasPermission name="loan:ptlist:verify">
    <input id="p_ptverify" style="display: none" value="1">
</shiro:hasPermission>
	<div class="row">
		<div class="col-lg-12">
								...
								<div class="row">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											...
											<input type="text" class="form-control" id="minUserVerifyTime" name="minUserVerifyTime" readonly="readonly">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<input type="text" class="form-control" id="maxUserVerifyTime" name="maxUserVerifyTime" readonly="readonly">
											<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
						...
						<table id="myTable"
							...
							<thead>
								<tr>
									...
									<th data-field="user_verify_time">企业审核时间</th>
	...
	function tableCallBack(data,id){
        if(id == 'button'){
        	var str = "";
        	if($("#p_ptverify").val() == 1){
	            str += '<button type="button" class="btn btn-primary btn-xs" onclick="queryLoan(\'' + data.id + '\');">审核</button>';;
        	}
        	return str;
        }else{
