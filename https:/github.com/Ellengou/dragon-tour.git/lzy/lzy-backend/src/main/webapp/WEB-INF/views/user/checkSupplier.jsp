...
<body>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
									<div class="row">
										<div class="col-xs-3">
											<img src="${baseUrl }${supplierInfo.lealFrontPicUrl}" class="img-rounded" style="width: 100px;height: 100px" onclick="showPic('${baseUrl }${supplierInfo.lealFrontPicUrl}');">
											<label class="checkbox-inline">
										...
										<div class="col-xs-3">
											<img src="${baseUrl }${supplierInfo.lealBackPicUrl}" class="img-rounded" style="width: 100px;height: 100px" onclick="showPic('${baseUrl }${supplierInfo.lealBackPicUrl}');">
											<label class="checkbox-inline">
										...
										<div class="col-xs-3" id="orgId">
											<img src="${baseUrl }${supplierInfo.organizationPicUrl}" class="img-rounded" style="width: 100px;height: 100px" onclick="showPic('${baseUrl }${supplierInfo.organizationPicUrl}');">
											<label class="checkbox-inline">
										...
										<div class="col-xs-3" id="busId">
											<img src="${baseUrl }${supplierInfo.businessLicensePicUrl}" class="img-rounded" style="width: 100px;height: 100px" onclick="showPic('${baseUrl }${supplierInfo.businessLicensePicUrl}');">
											<label class="checkbox-inline">
									...
									<div class="row" id="dlxx">
										<div class="col-xs-3">
											<img src="${baseUrl }${supplierInfo.agentFrontPicUrl}" class="img-rounded" style="width: 100px;height: 100px" onclick="showPic('${baseUrl }${supplierInfo.agentFrontPicUrl}');">
											<label class="checkbox-inline">
										...
										<div class="col-xs-3">
											<img src="${baseUrl }${supplierInfo.agentBackPicUrl}" class="img-rounded" style="width: 100px;height: 100px" onclick="showPic('${baseUrl }${supplierInfo.agentBackPicUrl}');">
											<label class="checkbox-inline">
										...
										<div class="col-xs-3">
											<img src="${baseUrl }${supplierInfo.proxyPicUrl}" class="img-rounded" style="width: 100px;height: 100px" onclick="showPic('${baseUrl }${supplierInfo.proxyPicUrl}');">
											<label class="checkbox-inline">
	...
	<script>
		...
		function submit() {
			...
			layer.load(2);
			$.ajax({
  			      url: '<%=request.getContextPath()%>/admin/userFront/checkSupplier',
  			      dataType: 'json',
  			      type: 'POST',
  			      data: jsonData,
