...
<body>
								...
								<form id="myForm">
									...
									<div class="row">
										<div class="col-xs-12">
											<div class="input-group">
												<span class="input-group-addon">额度比例</span> 
									...
									<div class="row" align="center">
										<div class="col-xs-12">
											...
											<input type="hidden" id="compCordId" name="compCordId" value="${compCordId}">
	...
	<script>
		$.validator.addMethod("proportion",function(value,element,params){
		...
		function submit() {
			...
			layer.load(2);
			$.ajax({
		      url: '<%=request.getContextPath()%>/admin/company/editCompanyProportion',
		      dataType: 'json',
		      type: 'POST',
		      data: jsonData,
