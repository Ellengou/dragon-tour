...
<body>
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div  class="form-group">
				...
				<div class="input-group col-xs-9">
					<input type="text" class="form-control" name="dicDataName" id="dicDataName"  value="${dic.dicDataName }">
				</div>
			</div>
			<div  class="form-group">
				<label class="col-xs-2 control-label">字典描述</label>
				<div class="input-group col-xs-9">
					<input type="text" class="form-control" name="dicDataDes" id="dicDataDes"  value="${dic.dicDataDes }">
				</div>
			</div>
			<div  class="form-group">
	...
	$(document).ready(function(){
		...
		var valueFlag = '${dic.valueFlag}';
		if('' != valueFlag){
			$("input[name='valueFlag']").each(function(){
				var $this = $(this);
				if(valueFlag == $this.val()){
					$this.attr('checked',true);
				}else{
				}
			});
