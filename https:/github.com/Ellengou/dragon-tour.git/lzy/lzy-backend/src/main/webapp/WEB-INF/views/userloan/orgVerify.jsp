...
<body>
	...
	//单独激活每个标签
		$('#myTab a').click(function (e) {
		  ...
		  if($this.attr('href') == "#verifySituation"){
			  ...
			  $("#dataIframe").attr('src','<%=request.getContextPath()%>/admin/userloan/getUserLoanQyOrgPics?userLoanId=${loan.id}');
	...
	function verify(){
		layer.open({
    	    ...
    	    title: '输入审核内容',
    	    content: '<%=request.getContextPath()%>/admin/userloan/orgVerifyPage?id=' + '${loan.id}'
    	});
    }
	</script>
</body>
