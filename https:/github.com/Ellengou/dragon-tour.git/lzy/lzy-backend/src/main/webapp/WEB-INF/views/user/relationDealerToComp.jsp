...
<body>
	<div class="row">
		<shiro:hasPermission name="subCompany:relationDealer">
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="myTable"
							...
							data-url="<%=request.getContextPath()%>/admin/company/queryRelationDealerCompanys"
							data-pageSize="10,50,100" data-method="POST">
							<thead>
								<tr>
									<th width="10%" data-field="id">ID</th>
									<th width="15%" data-field="compName">子公司名称</th>
	...
	function unRelation(suppId){
    	...
    	layer.confirm('是否确定此操作？', {
    	  btn: ['确定','取消'] //按钮
    		...
    		$.ajax({
  		      url: '<%=request.getContextPath()%>/admin/company/oplogUnRelationCompanyToDealer',
  		      dataType: 'json',
  		      type: 'POST',
  		      data: {
  		    	  suppId : suppId,
