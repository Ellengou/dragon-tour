								...
								<div class="row">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<span class="input-group-addon">还款时间</span>
											<input type="text" class="form-control" id="minCompleteTime" name="minCompleteTime" readonly="readonly">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<input type="text" class="form-control" id="maxCompleteTime" name="maxCompleteTime" readonly="readonly">
											<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
						...
						<table id="myTable"
							...
							<thead>
								<tr>
									...
									<th data-field="currentPayDay">还款到期日</th>
									<th data-field="yhqsAndwhqs">已还期数/剩余期数</th>
									<th data-field="allPayedMoney">已还金额</th>
