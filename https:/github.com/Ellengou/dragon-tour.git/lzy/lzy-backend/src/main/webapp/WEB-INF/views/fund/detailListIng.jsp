...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <font size="">&nbsp;&nbsp;费用合计：<span id="money_all">0.00</span>&nbsp;&nbsp;</font>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table id="myTable"
                           ...
                           data-url="<%=request.getContextPath()%>/admin/fund/detailIng/json?type=0"
                        ...
                        <tr>
                            ...
                            <th width="11%" data-field="compName">所属公司</th>
                            <%--<th width="10%" data-field="phone">手机号</th>--%>
                            <th width="8%" data-field="money" >费用金额</th>
                            <th width="12%" data-field="typeInfo" data-call="true">费用名称</th>
                            <th width="10%" data-field="total" >总资产</th>
                            <th width="10%" data-field="balance" >可用总额</th>
                            <th width="10%" data-field="frozenMoney" >冻结总额</th>
