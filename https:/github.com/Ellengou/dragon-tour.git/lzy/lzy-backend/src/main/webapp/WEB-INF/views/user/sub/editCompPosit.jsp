...
<body>
									...
									<div class="row">
										<div class="col-xs-12">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="name" name="name" value="${compPosit.name}">
												<input type="hidden" id="id" value="${compPosit.id}">
											</div>
										</div>
									</div>
									<hr>
	...
	<script>
		...
		function submit() {
			...
			$.ajax({
		      url: '<%=request.getContextPath()%>/admin/subCompany/editCompPosit',
		      dataType: 'json',
		      type: 'POST',
		      data: jsonData,
