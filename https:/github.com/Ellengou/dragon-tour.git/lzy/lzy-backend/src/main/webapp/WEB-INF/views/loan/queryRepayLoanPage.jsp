...
<body>
						...
						<table id="myTable"
							...
							<thead>
								<tr>
									...
									<th data-field="currentPayDay">最近一期还款到期日</th>
									<th data-field="yhqsAndwhqs">已还期数/剩余期数</th>
									<th data-field="allPayedMoney">已还总金额</th>
									<th data-field="needPayMoney">待还总金额</th>
	...
	function tableCallBack(data,id){
        if(id == 'button'){
        	...
        	str += '&nbsp<button type="button" class="btn btn-primary btn-xs" onclick="queryRepayInfo(\'' + data.id + '\');">还款计划</button>';
            return str;
        }else{
	...
	function queryRepayInfo(id){
		var index = layer.open({
            ...
            title: false,
            content: '<%=request.getContextPath()%>/admin/project/loan/queryRepayInfoPage?id=' + id
        });
		layer.full(index);
	}
