...
<body>
									...
									<div class="row">
										<div class="col-xs-4">
											<div class="input-group">
												...
												<input type="hidden" class="form-control" id="bankId" name="bankId" value="${bankId}">
											</div>
										</div>
										<div class="col-xs-4">
											<div class="input-group">
									...
									<div class="row">
										<div class="col-xs-4">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="penLimit" name="penLimit">
											</div>
										</div>
										<div class="col-xs-4">
											<div class="input-group">
												<span class="input-group-addon">每日限额</span> 
												<input type="text" class="form-control" id="dayLimit" name="dayLimit">
											</div>
										</div>
										<div class="col-xs-4">
											<div class="input-group">
												<span class="input-group-addon">每月限额</span> 
												<input type="text" class="form-control" id="monthLimit" name="monthLimit">
											</div>
										</div>
									</div>
									<hr>
	...
	<script>
		...
		function submit() {
			...
			$.ajax({
		      url: '<%=request.getContextPath()%>/admin/bankLimit/addBankLimit',
		      dataType: 'json',
		      type: 'POST',
		      data: jsonData,
