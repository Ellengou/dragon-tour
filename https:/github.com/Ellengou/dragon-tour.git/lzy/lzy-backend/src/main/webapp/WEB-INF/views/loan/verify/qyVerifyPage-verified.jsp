...
<div id="page-wrapper" style="padding: 0 15px;">
								...
								<form id="myForm">
									...
									<div  class="form-group">
										...
										<div class="input-group col-xs-9">
											<textarea class="form-control" rows="3" id = "reasonUser" name="reasonUser">${reason }</textarea>
										</div>
									</div>
									<div  class="form-group">
	...
	function ajaxFileUpload(id,data)  
	 {  
	     $.ajaxFileUpload({  
            url:'<%=request.getContextPath()%>/admin/project/loan/uploadfile?type=qy&loanId=${id }',  
            //secureuri:false,  
            fileElementId:id,
            dataType: 'json',
