...
<body>
								...
								<div class="row">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											...
											<input class="form-control " type="text" id="minFkTime"  name="minFkTime"  readonly>
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<input class="form-control" type="text" id="maxFkTime" name="maxFkTime"  readonly>
							                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
							                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-xs-3">
										<div class="input-group date form_time">
											...
											<input class="form-control " type="text" id="minExpireTime"  name="minExpireTime"  readonly>
							                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
							                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<input class="form-control" type="text" id="maxExpireTime" name="maxExpireTime"  readonly>
							                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
							                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="myTable"
							...
							data-url="<%=request.getContextPath()%>/admin/userloan/queryOrgRepayingUserLoan"
							...
							<thead>
								<tr>
									...
									<th data-field="dataSource" data-call="true">数据来源</th>
									<th data-field="fkTime">放款时间</th>
	...
	function uploadFile(){
    	layer.open({
    	    ...
    	    title: '导入还款中的借款',
    	    content: ['<%=request.getContextPath()%>/admin/userloan/uploadUserLoanPage?status=waiting_give_money','no']
    	});
    }
	</script>
</body>
