...
<body>
									...
									<div class="row">
										<div class="col-xs-12">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="creditCode" name="creditCode" value="${company.creditCode}">
											</div>
										</div>
									</div>
									<br>
	...
	<script>
		...
		function submit() {
			...
			layer.load(2);
			$.ajax({
			      url: '<%=request.getContextPath()%>/admin/company/editCompany',
			      dataType: 'json',
			      type: 'POST',
			      data: jsonData,
			      success: function (data) {
