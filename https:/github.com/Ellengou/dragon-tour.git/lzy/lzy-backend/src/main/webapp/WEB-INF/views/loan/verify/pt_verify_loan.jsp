...
<body>
						...
						<div class="row">
							<div class="col-lg-12">
								<form id="myForm">
									...
									<div id="myTabContent" class="tab-content">
									   ...
									   <div class="tab-pane fade" id="dataProve">
											  ...
											  <div class="panel-body">
										   		<input id="dataFile_base" type="file" class="file" multiple disabled="disabled">
											  </div>
											</div>
											<div class="panel panel-default">
											  <div class="panel-heading">
											    <h3 class="panel-title">企业审核补充资料</h3>
											  </div>
											  <div class="panel-body">
										   		<input id="dataFile_qysh" type="file" class="file" multiple disabled="disabled">
											  </div>
											</div>
									   </div>
								...
								<div class="row" align="center">
									<div class="col-xs-12">
									<shiro:hasPermission name="loan:pt:verify">
	...
	$('#dataFile_base').fileinput({
        language: 'zh',
        initialPreview:getInitialPreview('${baseList}'),
        initialPreviewConfig:getInitialPreviewConfig('${baseList}'),
    ...
    $('#dataFile_qysh').fileinput({
        language: 'zh',
        initialPreview:getInitialPreview('${qyshList}'),
        initialPreviewConfig:getInitialPreviewConfig('${qyshList}'),
        initialPreviewFileType:'image',
        showRemove:false,
        showUpload:false,
        showCancel:false,
	...
	function verify(id){
		layer.open({
    	    ...
    	    title: '输入审核内容',
    	    content: '<%=request.getContextPath()%>/admin/project/loan/ptVerifyPage?id=' + id
    	});
    }
