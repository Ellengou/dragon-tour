...
<body>
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="myTable"
							...
							data-url="<%=request.getContextPath()%>/admin/project/loan/queryQyFailLoans"
							...
							<thead>
								<tr>
									...
									<th data-field="user_verify_time">审核时间</th>
	...
	function tableCallBack(data,id){
        if(id == 'button'){
            return '<button type="button" class="btn btn-primary btn-xs" onclick="queryLoan(\'' + data.id + '\');">查看</button>';;
        }else{
	...
	function queryLoan(id){
		var index = layer.open({
            ...
            title: false,
            content: '<%=request.getContextPath()%>/admin/project/loan/viewLoan?id=' + id
        });
		layer.full(index);
	}
