...
<body>
<shiro:hasPermission name="loan:mblist:verify">
    <input id="p_mbverify" style="display: none" value="1">
</shiro:hasPermission>
	<div class="row">
		<div class="col-lg-12">
								...
								<div class="row">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											...
											<input type="text" class="form-control" id="minFullInvestTime" name="minFullInvestTime" readonly="readonly">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<input type="text" class="form-control" id="maxFullInvestTime" name="maxFullInvestTime" readonly="readonly">
											<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
						...
						<table id="myTable"
							...
							<thead>
								<tr>
									...
									<th data-field="loan_count">投标人数(人)</th>
									<th data-field="hs">耗时</th>
									<th data-field="full_invest_time">满标时间</th>
	...
	function tableCallBack(data,id){
        if(id == 'button'){
        	var str = "";
        	if($("#p_mbverify").val() == 1){
	            str += '<button type="button" class="btn btn-primary btn-xs" onclick="queryLoan(\'' + data.id + '\');">查看</button>';;
        	}
        	return str;
        }else{
	...
	function queryLoan(id){
		var index = layer.open({
            ...
            title: false,
            content: '<%=request.getContextPath()%>/admin/project/loan/${viewType}?id=' + id
        });
		layer.full(index);
	}
