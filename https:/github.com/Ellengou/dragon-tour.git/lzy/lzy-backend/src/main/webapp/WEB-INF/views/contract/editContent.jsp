...
<body>
	...
	<script>
		$(document).ready(function() {
			...
			$('#summernote').summernote('code','${scfContent.content}');
		...
		function submit() {
			...
			if($('#file_name').val() != null && $('#file_name').val() != ''){
				$.ajaxFileUpload({
					url : '<%=request.getContextPath()%>/admin/contractContent/uploadPic',
					secureuri:false,
			        method : 'POST',  
					...
					success: function (data, status) {
						if(data.status == 'ok'){
							...
							$.ajax({
							      url: '<%=request.getContextPath()%>/admin/contractContent/editContent',
							      dataType: 'json',
							      type: 'POST',
							      data: jsonData,
		...
		function checkSerialNum(){
			...
			$.ajax({
			      url: '<%=request.getContextPath()%>/admin/contractContent/getContentBySerialNum',
			      dataType: 'json',
			      type: 'POST',
			      data: {
