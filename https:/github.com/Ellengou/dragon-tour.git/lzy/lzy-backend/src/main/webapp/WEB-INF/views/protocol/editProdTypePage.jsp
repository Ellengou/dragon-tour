...
<body>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="myForm">
									<input type="text" id = "id" name="id" value="${prodType.id }" hidden="true">
									<div class="row">
										<div class="col-xs-12">
											<div class="input-group">
												<span class="input-group-addon">名称</span> 
												<input type="text" class="form-control" id="name" name="name" value="${prodType.name }">
											</div>
										</div>
									</div>
									<br>
									...
									<div class="row" align="center">
										<div class="col-xs-12">
										<shiro:hasPermission name="prod:type:update">
	...
	<script>
		$("#pid").showList('option',{infoList:'${topList}',column_name:'name',column_value:'id',selectValue:'${prodType.pid}'})
		function submit(){
			var jsonData = {};
			...
			$.ajax({
			      url: '<%=request.getContextPath()%>/admin/prodType/update',
			      dataType: 'json',
			      type: 'POST',
			      data: jsonData,
