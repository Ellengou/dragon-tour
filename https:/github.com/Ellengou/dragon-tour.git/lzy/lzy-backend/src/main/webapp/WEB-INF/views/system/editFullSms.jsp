...
<body>
									...
									<div class="row">
										<div class="col-xs-4">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="name" name="name" value="${scfFullSms.name}">
												<input type="hidden" id="id" value="${scfFullSms.id}">
											</div>
										</div>
										...
										<div class="col-xs-4">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="phone" name="phone" value="${scfFullSms.phone}">
	...
	<script>
		...
		function submit() {
			...
			$.ajax({
		      url: '<%=request.getContextPath()%>/admin/full/editFullSms',
		      dataType: 'json',
		      type: 'post',
		      data: jsonData,
