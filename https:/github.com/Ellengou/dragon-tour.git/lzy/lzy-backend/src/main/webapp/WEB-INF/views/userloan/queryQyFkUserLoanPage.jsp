...
<body>
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="myTable"
							...
							data-url="<%=request.getContextPath()%>/admin/userloan/queryQyFkUserLoan"
	...
	function tableCallBack(data,id){
        if(id == 'button'){
            return '<button type="button" class="btn btn-primary btn-xs" onclick="queryUserLoan(\'' + data.id + '\');">放款</button>';;
        }else{
	...
	function queryUserLoan(id){
		var index = layer.open({
	        ...
	        title: false,
	        content: '<%=request.getContextPath()%>/admin/userloan/qyGiveMoney?id=' + id
	    });
		layer.full(index);
	}
	</script>
