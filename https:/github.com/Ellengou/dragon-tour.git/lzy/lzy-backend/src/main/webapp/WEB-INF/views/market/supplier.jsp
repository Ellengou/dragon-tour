            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table id="myTable"
                           ...
                           data-url="<%=request.getContextPath()%>/admin/market/querySuppliers"
                           data-pageSize="10,50,100" data-method="GET">
                        <thead>
                        <tr>
                            <th width="20%" data-field="custname">供应商名称</th>
                            <th width="20%" data-field="unitshortname">质押单位</th>
...
<script>
    ...
    function viewDetail(custcode, pk_corp) {
    	var index = layer.open({
    	    ...
    	    title: '供应商详情',
    	    content: ['<%=request.getContextPath()%>/admin/market/supplierDealPage?custcode=' + custcode + '&pk_corp=' + pk_corp,'yes']
    	});
    	layer.full(index);
    }
</script>
