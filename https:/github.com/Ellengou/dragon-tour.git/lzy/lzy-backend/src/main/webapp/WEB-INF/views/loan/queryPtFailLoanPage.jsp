								...
								<div class="row">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											...
											<input type="text" class="form-control" id="minSysVerifyTime" name="minSysVerifyTime" readonly="readonly">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<input type="text" class="form-control" id="maxSysVerifyTime" name="maxSysVerifyTime" readonly="readonly">
											<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
						...
						<table id="myTable"
							...
							<thead>
								<tr>
									...
									<th data-field="sys_verify_time">提交时间</th>
