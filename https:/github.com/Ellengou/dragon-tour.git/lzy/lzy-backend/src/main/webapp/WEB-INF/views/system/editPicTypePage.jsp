...
<body>
									...
									<div class="row">
										<div class="col-xs-4">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="name" name="name" value="${scfPicType.name}">
												<input type="hidden" id="id" value="${scfPicType.id}">
											</div>
										</div>
											<div class="col-xs-4">
											<div class="input-group">
												<span class="input-group-addon">值</span> 
												<input type="text" class="form-control" id="val" name="val" value="${scfPicType.val}">
											</div>
										</div>
										<div class="col-xs-4">
											<div class="input-group">
	...
	<script>
		$(document).ready(function() {
			...
			$("#platform").val('${scfPicType.platform}');
		...
		function submit() {
			...
			var object={'url':'<%=request.getContextPath()%>/admin/system/picType/editPicType',
	    			'data':jsonData};
	    	commons(object);
