...
<body>
	<div id="page-wrapper" style="padding: 0 15px;">
		<div class="row">
			<div class="col-lg-12">
				<br>
				<span id="sumContent" hidden>${scfContent.content}</span>
									...
									<div class="row">
										<div class="col-xs-3">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="serialNum" name="serialNum" value="${scfContent.serialNum}" onchange="checkSerialNum();">
											</div>
										</div>
										<div class="col-xs-3">
											<div class="input-group">
												<span class="input-group-addon">标题</span> 
												<input type="text" class="form-control" id="title" name="title" value="${scfContent.title}">
											</div>
										</div>
										<div class="col-xs-3">
											<div class="input-group">
												<span class="input-group-addon">作者</span> 
												<input type="text" class="form-control" id="author" name="author" value="${scfContent.author}">
											</div>
										</div>
										<div class="col-xs-3">
											<div class="input-group">
									...
									<div class="row">
										<div class="col-xs-3">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="seqNum" name="seqNum" value="${scfContent.seqNum}">
												<input type="hidden"id="id" value="${scfContent.id}">
											</div>
										</div>
										<div class="col-xs-6">
											<div class="input-group">
												<span class="input-group-addon">关键词</span> 
												<input type="text" class="form-control" id="keyWord" name="keyWord" value="${scfContent.keyWord}">
											</div>
										</div>
									</div>
									<br>
									<div class="row">
										<div class="col-xs-12">
											<div class="input-group">
												...
												<input type="text" class="form-control" id="summary" name="summary" value="${scfContent.summary}" maxlength="200">
											</div>
										</div>
									</div>
									<br>
									<div class="row">
										<div class="col-xs-6" style="display: block" id="showPicUrl">
											<img src="${scfContent.picUrl}" class="img-rounded" style="width: 100px;height: 100px">
											<button type="button" class="btn btn-primary" onclick="editPic('1');">修改</button>
										</div>
										<div class="col-xs-6" style="display: none" id="editPicUrl">
											<div class="input-group">
												<span class="input-group-addon">标题图片</span> 
												<input type="file" class="form-control" id="file_name" name="file_name">
												<span class="input-group-addon" onclick="editPic('2');">返回</span>
											</div>
										</div>
									</div>
									<hr>
	...
	<script>
		$(document).ready(function() {
			...
			if('${scfContent.picUrl}' == null || '${scfContent.picUrl}' == ''){
				editPic('1');
			}
			...
			$("#programaId").val('${scfContent.programaId}');
				...
				$.ajaxFileUpload({
					...
					success: function (data, status) {
						if(data.status == 'ok'){
							...
							$.ajax({
							      url: '<%=request.getContextPath()%>/admin/content/editContent',
							      dataType: 'json',
							      type: 'POST',
							      data: jsonData,
		...
		function checkSerialNum(){
			if('${scfContent.serialNum}' == $('#serialNum').val()){
				return;
			}
