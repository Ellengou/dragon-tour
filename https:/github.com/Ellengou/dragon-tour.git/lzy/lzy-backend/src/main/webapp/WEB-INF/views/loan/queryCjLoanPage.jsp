								...
								<div class="row">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											...
											<input type="text" class="form-control" id="minUpInvestTime" name="minUpInvestTime" readonly="readonly">
									...
									<div class="col-xs-3">
										<div class="input-group date form_time">
											<input type="text" class="form-control" id="maxUpInvestTime" name="maxUpInvestTime" readonly="readonly">
											<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
						...
						<table id="myTable"
							...
							<thead>
								<tr>
									...
									<th data-field="loan_count">投标人数/进度</th>
