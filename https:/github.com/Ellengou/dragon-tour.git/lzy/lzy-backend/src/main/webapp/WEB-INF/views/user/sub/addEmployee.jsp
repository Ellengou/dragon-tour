								...
								<div class="row">
									<div class="col-xs-4">
										<div class="input-group">
											...
											<input type="hidden" id="companyId" name="companyId" value="${sysUserImportInfo.companyId}">
											<input type="hidden" id="id" name="id" value="${sysUserImportInfo.id}">
										</div>
									</div>
									<div class="col-xs-4">
										<div class="input-group">
...
<script>
	...
	$(document).ready(function() {
		...
		if (action == 'update') {
			$('#positId').val(${sysUserImportInfo.positId});
			$('#orgId').val(${sysUserImportInfo.orgId});
			$('#sex').val(${sysUserImportInfo.sex});
			$('#education').val(${sysUserImportInfo.education});
		}
...
//						required: true,
	...
	function submit() {
		...
		$.ajax({
			url: '<%=request.getContextPath()%>/admin/subCompany/addEmployee/${action}',
			dataType: 'json',
			type: 'POST',
			data: jsonData,
			success: function (data) {
