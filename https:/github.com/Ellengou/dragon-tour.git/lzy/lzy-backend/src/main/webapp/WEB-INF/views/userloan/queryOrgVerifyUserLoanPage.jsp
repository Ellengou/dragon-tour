...
<body>
<shiro:hasPermission name="userloan:org:verify">
    <input id="p_orgverify" style="display: none" value="1">
</shiro:hasPermission>
	<div class="row">
		<div class="col-lg-12">
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="myTable"
							...
							data-url="<%=request.getContextPath()%>/admin/userloan/queryOrgVerifyUserLoan"
	...
	function tableCallBack(data,id){
        if(id == 'button'){
        	var str = "";
        	if($("#p_orgverify").val() == 1){
        		str += '<button type="button" class="btn btn-primary btn-xs" onclick="queryUserLoan(\'' + data.id + '\');">审核</button>';;
        	}
        	return str;
        }else{
	...
	function queryUserLoan(id){
		var index = layer.open({
	        ...
	        title: false,
	        content: '<%=request.getContextPath()%>/admin/userloan/orgVerify?id=' + id
	    });
		layer.full(index);
	}
	</script>
