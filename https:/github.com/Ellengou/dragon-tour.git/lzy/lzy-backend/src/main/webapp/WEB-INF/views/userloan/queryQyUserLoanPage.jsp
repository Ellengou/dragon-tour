...
<body>
<shiro:hasPermission name="userloan:qy:verify">
    <input id="p_qyverify" style="display: none" value="1">
</shiro:hasPermission>
	<div class="row">
		<div class="col-lg-12">
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="myTable"
							...
							data-url="<%=request.getContextPath()%>/admin/userloan/queryQyVerifyUserLoan"
	...
	function queryUserLoan(id){
		var index = layer.open({
	        ...
	        title: false,
	        content: '<%=request.getContextPath()%>/admin/userloan/qyVerify?id=' + id
	    });
		layer.full(index);
	}
