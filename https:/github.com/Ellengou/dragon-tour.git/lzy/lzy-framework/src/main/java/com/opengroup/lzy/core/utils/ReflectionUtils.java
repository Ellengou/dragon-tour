...
public abstract class ReflectionUtils {
	...
	public static Type[] getFieldGenricTypes(final Field field) {
		Type mainType = field.getGenericType();
		return getGenricTypes(mainType);
	}

	public static Type getFieldGenricType(final Field field, final Integer index) {
		Type mainType = field.getGenericType();
		return getGenricType(mainType, index);
	}

	public static Type getGenricType(final Type mainType, final Integer index) {
		Type[] types = getGenricTypes(mainType);
		return types[index];
	}

	public static Type[] getGenricTypes(final Type mainType) {
