...
public class ArrayUtils extends org.apache.commons.lang3.ArrayUtils {
	...
	public static String toSimpleString(Object[] array) {
		StringBuffer sb = new StringBuffer(org.apache.commons.lang3.ArrayUtils.toString(array));
		if (sb.length() > 0)
	...
	public static String toSimpleString(Object[] array, String stringIfNull) {
		StringBuffer sb = new StringBuffer(org.apache.commons.lang3.ArrayUtils.toString(array, stringIfNull));
		if (sb.length() > 0)
			return sb.substring(1, sb.length() - 1);
		return "";
	}
