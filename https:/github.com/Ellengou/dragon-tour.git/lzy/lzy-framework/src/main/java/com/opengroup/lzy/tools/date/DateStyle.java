 ...
 * @author lc
 *
 * @date 2017年1月3日 下午6:35:46
 */
public enum DateStyle {

	YYYY_MM("yyyy-MM", false), YYYY_MM_DD("yyyy-MM-dd", false), YYYY_MM_DD_HH_MM(
			"yyyy-MM-dd HH:mm", false), YYYY_MM_DD_HH_MM_SS(
			"yyyy-MM-dd HH:mm:ss", false), YY_MM_DD("yy-MM-dd", false), YYMMDD(
			"yyMMdd", false), YYMMDDHHMM("yyMMddHHmm", false),
	...
	YYYY("yyyy", true),MM("MM", true),DD("dd", true),
	YYYY_MM_DD_HH_MM_DOTE("yyyy.MM.dd HH:mm", true);
