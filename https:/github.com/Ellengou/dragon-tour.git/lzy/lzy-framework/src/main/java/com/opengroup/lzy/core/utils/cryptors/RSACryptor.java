package com.opengroup.lzy.core.utils.cryptors;

import com.opengroup.lzy.core.utils.EnCryptors;
...
public class RSACryptor {
    ...
    public String encrypt(String privateKeyStr, byte[] data) {
        try {
            ...
            //return raw;
            return new String(EnCryptors.BASE64.encode(raw, false));
    ...
    public String sign(String content, String privateKeyStr) {
        try {
            ...
            return new String(EnCryptors.BASE64.encode(signed, false));
        } catch (NoSuchAlgorithmException e) {
            throw new RuntimeException("无此算法", e);
    ...
    public boolean verify(String data, String sign, String publicKeyStr) {
        return verify(data.getBytes(), sign, publicKeyStr);
    }
    ...
    public boolean verify(byte[] data, String sign, String publicKeyStr) {
        try {
            ...
            boolean bverify = signature.verify(EnCryptors.BASE64.decode(sign));
            return bverify;
