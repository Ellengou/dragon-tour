...
public class DateUtil {/*
	...
	*//**
	 ...
	 * @param otherDate
	 *            另一个日期
	 * @return 相差天数。可能返回负数，如果失败了返回99999
	 *//*
	public static int getIntervalDaysNo(Date date, Date otherDate) {
		int num = 99999;
		Date dateTmp = DateUtil.StringToDate(DateUtil.getDate(date),
				DateStyle.YYYY_MM_DD);
		Date otherDateTmp = DateUtil.StringToDate(DateUtil.getDate(otherDate),
		...
		if (dateTmp.getTime() < otherDateTmp.getTime()) {
			return -num;
		}
		return num;
	}
	...
	*//**
	...
	public static Date getNow() {
		String nowTime = DateToString(new Date(), DateStyle.YYYY_MM_DD_HH_MM_SS);
		return StringToDate(nowTime);
	}
	...
	*//**
	...
	public static Date getCurrentDate() {
		String nowTime = DateToString(new Date(), DateStyle.YYYY_MM_DD);
		return StringToDate(nowTime, DateStyle.YYYY_MM_DD);
	}
	...
	*//**
	 ...
	 * @return
	 *//*
	public static String getDateForStyle(DateStyle style) {
		String Date = DateToString(new Date(), style);
		return Date;
	}

	*//**
	 * 比较日期大小 date1 大于date2 返回1 相等返回0 小于返回-1
	 * 
	 * @param date1
	 * @param date2
	 * @return
	...
	*//**
	 ...
	 * @return
	 *//*
	public static String getLastTime(Date startTime, Date endTime) {
		long diff = endTime.getTime() - startTime.getTime();
		long day = diff / (3600 * 24 * 1000);
		long hour = (diff % (3600 * 24 * 1000)) / (3600 * 1000);
		long minute = (diff % (3600 * 1000)) / (60 * 1000);
	...
	*//**
	...
	public static int getDays(Date date) {
		...
		if (date != null) {
			calendar.setTime(date);
			num = calendar.getActualMaximum(Calendar.DATE);
		}
		return num;
	...
	*//**
	...
	public static void main(String[] args) {
		System.out.println(getCurMonthLastDay());
		System.out.println(getCurMonthBeginDay());
	}
*/}