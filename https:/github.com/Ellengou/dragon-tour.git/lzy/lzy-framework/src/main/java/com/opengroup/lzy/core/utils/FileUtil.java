...
public class FileUtil {
	...
	public static String getContentType(String filename) {
		String extname = getExtFilename(filename);
...
//		new FileUploadUtil().Upload(new File(""));
//
//		FileUtil.createDirs("/Users/ellengou/Downloads/文本.txt ", false);
...
//		}
		System.out.print(FileUtil.getFilename("http://www.baidu.com/ellen/123.txt"));
	}
